...
class UserPurchasesController extends Controller
{
    ...
    public function index( $id )
    {
    	...
    	return view('admin.users.purchases.purchases', $this->data);
    }
    ...
    public function createInvoice(InvoiceRequest $request, $user_id)
    {
        ...
        return redirect()->route( 'admin.user.purchases.invoice_details', ['id' => $user_id, 'invoice_id' => $invoice->id] );
    }
    ...
    public function addItem(InvoiceProductRequest $request, $user_id, $invoice_id)
    {
        ...
        return redirect()->route( 'admin.user.purchases.invoice_details', ['id' => $user_id, 'invoice_id' => $invoice_id] );
    }
    ...
    public function destroy($user_id, $invoice_id)
    {
        ...
        return redirect()->route( 'admin.user.purchases', ['id' => $user_id] );
    }
