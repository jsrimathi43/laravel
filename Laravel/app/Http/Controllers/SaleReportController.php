...
class SaleReportController extends Controller
{
    ...
    public function index( Request $request )
    {
    	...
    	$this->data['sales'] = SaleItem::select( 'sale_items.quantity', 'sale_items.price', 'sale_items.total', 'products.title',  
        'sale_invoices.challan_no','sale_invoices.date')
    	...
    	return view('/admin/users/reports/sales', $this->data);
    }
}