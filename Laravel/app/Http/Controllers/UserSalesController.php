...
class UserSalesController extends Controller
{
    ...
    public function index( $id )
    {
    	...
    	return view('admin.users.sales.sales', $this->data);
    }
    ...
    public function createInvoice(InvoiceRequest $request, $user_id)
    {
        ...
        return redirect()->route( 'admin.user.sales.invoice_details', ['id' => $user_id, 'invoice_id' => $invoice->id] );
    }
    ...
    public function invoice($user_id, $invoice_id)
    {
        ...
        return view('admin.users.sales.invoice', $this->data);
    }
    ...
    public function addItem(InvoiceProductRequest $request, $user_id, $invoice_id)
    {
        ...
        return redirect()->route( 'admin.user.sales.invoice_details', ['id' => $user_id, 'invoice_id' => $invoice_id] );
    }
    ...
    public function destroy($user_id, $invoice_id)
    {
        ...
        return redirect()->route( 'admin.user.sales', ['id' => $user_id] );
    }
