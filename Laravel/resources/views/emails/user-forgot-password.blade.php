    ...
    <div class="email-template-body">
            <div class="email-template-content">
              <div class="email-template-content-head">
                ...
                <div class="email-template-content-button"><a href = "{{ route('user.password.reset', $token) }}">{{ __('Forgot Password') }}</a></div>
                <div class="email-template-content-info">
                  ...
                  <div class="hr"></div>
                        <div class="email-template-content-info-link">
                          <p>If you're having trouble clicking the "Reset Password" button, copy and paste the URL below into your web browser: <a href = "{{ route('user.password.reset', $token) }}">Reset Password</a> </p>
                        </div>
                  </div>
            </div>
    </div>
